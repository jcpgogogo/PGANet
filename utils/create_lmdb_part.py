...
def create_lmdb_for_SIDD():
    folder_path = '/home/lhc/work/NAFNet-main/datapart2/train/input_crops'
    lmdb_path = '/home/lhc/work/NAFNet-main/datapart2/train/input_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'PNG')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/home/lhc/work/NAFNet-main/datapart2/train/gt_crops'
    lmdb_path = '/home/lhc/work/NAFNet-main/datapart2/train/gt_crops.lmdb'
