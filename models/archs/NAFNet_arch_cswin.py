...
import sys
sys.path.append('/home/zt/work/NAFNet-main/basicsr/models/archs')
from shiftvit import ShiftViTBlock
#from shiftvitall import ShiftViTBlock as ShiftViTBlockall
from cswintall import ConvTransBlock
...
class NAFBlock_swin(nn.Module):
    def __init__(self, c,image_size,DW_Expand=2, FFN_Expand=2, drop_out_rate=0.):
        super().__init__()
        ...
        # depth = 1,
        # heads = 16,
        # mlp_dim = dw_channel*2,
        # dropout = 0.1,
        # emb_dropout = 0.1
        # )]
        self.ctb = [ConvTransBlock(dw_channel // 2, dw_channel // 2, self.head_dim, self.window_size, 0,
                                       'W' , image_size)]
        # self.ctb = [Transformer(dw_channel//2, 1, 16, self.head_dim, dw_channel*2, 0) for i in range(1)]
    ...
    def __init__(self, img_channel=3, width=16, middle_blk_num=1, enc_blk_nums=[], dec_blk_nums=[]):
        ...
        for num in enc_blk_nums:
            self.encoders.append(
                nn.Sequential(NAFBlock_swin(chan,image_size),
