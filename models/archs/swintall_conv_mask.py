...
class WMSA(nn.Module):
    ...
    def mask_image(self, image, x_size=None):
        ...
        mask_ratio1=75
        mask_ratio2=75
        b_,_,_,_=image.shape
        image = rearrange(image, ' b w p c -> (b w) p c ')
        prob_ = random.randint(mask_ratio1, mask_ratio2) / 100
        ...
        noise_image1=rearrange(noise_image1, ' (b w) p c -> b w p c ',b=b_)
        return noise_image1
    def forward(self, x):
